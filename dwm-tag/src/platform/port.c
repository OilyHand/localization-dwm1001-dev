...
#define GPIO_NAME   DT_GPIO_LABEL(DT_NODELABEL(dwmirq), gpios)
#define GPIO_PIN    DT_GPIO_PIN(DT_NODELABEL(dwmirq), gpios)
#define GPIO_FLAGS  DT_GPIO_FLAGS(DT_NODELABEL(dwmirq), gpios)
